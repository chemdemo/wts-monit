...
* @Last Modified time: 2015-04-07 21:40:42
*/
...
function Client(sock, group) {
    ...
    sock.on('message', onSockMsg);

    this.id = this.sock.id = cid;
    this.host = sock.host = rHost;
    this.port = sock.port = rPort;
    this.status = sock.status = 'ready';
    this.group = sock.group = group;
    this._terms = sock._terms = {};
    this.socket = sock;
