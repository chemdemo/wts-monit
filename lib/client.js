...
* @Last Modified time: 2015-04-08 20:14:28
*/
...
_.assign(Client.prototype, {
    sendMsg: function(msg) {
        ...
        var buffer = new Input(msg);
        this.socket.write(buffer.encode().toString('utf8'));
    },
...
function onSockMsg(msg) {
    ...
    logger.info('received msg:%s from %s:%s', JSON.stringify(msg), this.host, this.port);
